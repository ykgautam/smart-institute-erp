...
//                        exception.authenticationEntryPoint(authenticationEntryPoint))
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll() // preflight must never hit JWT filter
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Vite dev server origin. Add production frontend origin(s) here
        // once deployed — never use "*" together with allowCredentials(true),
